...
public class AddAccountant extends JFrame implements ActionListener {
    ...
    AddAccountant() {
        ...
        label1 = new JLabel("ADD ACCOUNTANT DETAILS");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        String Amail = textMName.getText();
        String Afirst_name = textFName.getText();
        String Alast_name = textLName.getText();
        String Aphone = textOName.getText();
        ...
        if (e.getSource() == button1) {
            ...
            if (textName.getText().isEmpty() || textPName.getText().isEmpty() || textMName.getText().isEmpty()
                ...
                try {
                    ...
                    prst.setString(3, Amail);
                    prst.setString(4, Afirst_name);
                    prst.setString(5, Alast_name);
                    prst.setString(6, Aphone);
                    prst.executeUpdate();

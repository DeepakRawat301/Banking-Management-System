...
public class DebitMoney extends JFrame implements ActionListener {
    ...
    DebitMoney() {
        ...
        label1 = new JLabel("DEBIT TRANSACTION BENCHWORK");
                    ...
                    if (acc_no != null) {
                        ...
                        if (rs.next()) {
                            ...
                            if (amount <= current_balance) {
                                ...
                                PreparedStatement prst1 = c1.con.prepareStatement(debit_query);
